...
Este repositório é destinado ao desenvolvimento da terceira entrega do projeto do grupo 02 da disciplina de Arquitetura e Desenho de Software, ministrada pela professora Milene Serrano.

## Entrega 03

A terceira entrega aborda todo o escopo requisitado, considerando a realização de Padrões de Projeto GoF: Criacionais, Estruturais e Comportamentais.
Todas divididas em diferentes tópicos de entrega pelo GitPages:

#### 3. Padrões de Projeto GoF

3.1 Padrão de Projeto GoF Criacionais

3.2 Padrão de Projeto GoF Estruturais

3.3 Padrão de Projeto GoF Comportamentais
